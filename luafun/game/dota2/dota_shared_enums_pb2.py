...
_EDPCPUSHNOTIFICATION = _descriptor.EnumDescriptor(
  ...
  full_name='EDPCPushNotification',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_EEVENTACTIONSCOREMODE = _descriptor.EnumDescriptor(
  ...
  full_name='EEventActionScoreMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_EOVERWATCHREPORTREASON = _descriptor.EnumDescriptor(
  ...
  full_name='EOverwatchReportReason',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CMSGDOTACOMBATLOGENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='spell_generated_attack', full_name='CMsgDOTACombatLogEntry.spell_generated_attack', index=72,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='at_night_time', full_name='CMsgDOTACombatLogEntry.at_night_time', index=73,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attacker_has_scepter', full_name='CMsgDOTACombatLogEntry.attacker_has_scepter', index=74,
...
_CMSGPENDINGEVENTAWARD = _descriptor.Descriptor(
  ...
  full_name='CMsgPendingEventAward',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='event_id', full_name='CMsgPendingEventAward.event_id', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='action_id', full_name='CMsgPendingEventAward.action_id', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='num_to_grant', full_name='CMsgPendingEventAward.num_to_grant', index=2,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='score_mode', full_name='CMsgPendingEventAward.score_mode', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='audit_action', full_name='CMsgPendingEventAward.audit_action', index=4,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
