...
# -*- coding: utf-8 -*-
"""
luafun documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'luafun'))
...
project = u'Luafun'
_full_version = luafun.__version__
author = luafun.__author__
copyright = luafun.__copyright__
...
latex_documents = [
    (master_doc, 'luafun.tex', u'Luafun Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'luafun', 'Luafun Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Luafun', 'Luafun Documentation',
     author, 'luafun', luafun.__descr__,
     'Miscellaneous'),
]
